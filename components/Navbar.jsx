  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
        ...
        <a href="#top">
          <Image src={isDarkMode ? assets.logo_white : assets.logo2} className='w-40 cursor-pointer mr-14' alt='' />
        </a>
        ...
        <div className='flex items-center gap-6'>
          ...
          <a href="#contact" className='font-Ovo hidden lg:flex items-center gap-3 px-10 py-2.5 border 
          border-gray-500 rounded-full ml-4 dark:border-white/50'>Contact <Image alt='' src={isDarkMode ? 
          assets.arrow_icon_dark : assets.arrow_icon} className='w-3' /></a>
        ...
        w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
          <div className='absolute right-6 top-6' onClick={closeMenu}>
            <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='' className='w-6 mb-10 cursor-pointer' />
          </div>
